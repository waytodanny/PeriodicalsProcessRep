...
<body>
<jsp:include page="../webapp/pages/additional/header.jsp"/>
<jsp:include page="../webapp/pages/additional/cart.jsp"/>
<div id="products-wrapper" class="container">
    ...
    <jsp:include page="../webapp/pages/additional/pagination.jsp"/>
</div>
