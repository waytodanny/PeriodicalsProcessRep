...
public class PeriodicalIssuesJdbcDao extends AbstractJdbcDao<PeriodicalIssue, Long> implements PeriodicalIssuesDao {
    ...
    @Override
    public Long add(PeriodicalIssue element) throws DaoException {
        return null;
    }

    @Override
    public PeriodicalIssue getById(Long key) throws DaoException {
        return null;
    }

    @Override
    public void update(PeriodicalIssue object) throws DaoException {
    ...
    @Override
    protected Object[] getObjectUpdateParams(PeriodicalIssue object) throws DaoException {
        return new Object[0];
    }
