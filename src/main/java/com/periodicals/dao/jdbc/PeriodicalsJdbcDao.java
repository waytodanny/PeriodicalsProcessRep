...
public class PeriodicalsJdbcDao extends AbstractJdbcDao<Periodical, Integer> implements PeriodicalsDao {
    ...
    @Override
    public boolean isUserSubscribed(String uuid, Periodical per) throws DaoException {
        return false;
    }
    ...
    @Override
    public void addUserSubscriptions(String uuid, List<Periodical> subs) throws DaoException {
    ...
    @Override
    public Integer add(Periodical element) throws DaoException {
        return null;
    }

    @Override
    public Periodical getById(Integer key) throws DaoException {
        return null;
    }

    @Override
    public void update(Periodical object) throws DaoException {
    ...
    @Override
    protected Object[] getObjectUpdateParams(Periodical object) throws DaoException {
        return new Object[0];
    }
